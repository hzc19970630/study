      ...
      <el-col :span="17">
        <div class="often-goods">
          ...
          <div class="often-goods-list">
            <ul>
              <li v-for="(good,index) in oftenGoods" @click="addOrderList(good)" :key="index">
        ...
        <div class="goods-type">
          <el-tabs>
            <el-tab-pane label="汉堡">
              <ul class='cookList'>
                <li v-for="(good,index) in type0Goods" @click="addOrderList(good)" :key="index">
                  <span class="foodImg">
            ...
            <el-tab-pane label="小食">
              <ul class='cookList'>
                <li v-for="(good,index) in type1Goods" @click="addOrderList(good)" :key="index">
                  <span class="foodImg">
                    <img :src="good.goodsImg" height="80px" width="100%">
                  </span>
                  <span class="foodName">{{ good.goodsName }}</span>
            ...
            <el-tab-pane label="饮料">
              <ul class='cookList'>
                <li v-for="(good,index) in type2Goods" @click="addOrderList(good)" :key="index">
                  <span class="foodImg">
                    <img :src="good.goodsImg" height="80px" width="100%">
                  </span>
                  <span class="foodName">{{ good.goodsName }}</span>
            ...
            <el-tab-pane label="套餐">
              <ul class='cookList'>
                <li v-for="(good,index) in type3Goods" @click="addOrderList(good)" :key="index">
                  <span class="foodImg">
                    <img :src="good.goodsImg" height="80px" width="100%">
                  </span>
                  <span class="foodName">{{ good.goodsName }}</span>
